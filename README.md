...
火山引擎 TOS、Cloudflare R2、RustFS、Garage、SeaweedFS、Ceph、金山云 KS3、美团云 MSS、京东云 OSS、天翼云 OOS、天翼云 ZOS、移动 云EOS、沃云 OSS、
...
`2.4.0` Amazon S3 / Amazon S3 V2 新增 path-style-access、chunked-encoding、accelerate 配置项，支持对接 RustFS、Ceph RGW、Cloudflare R2 等 S3 兼容存储服务及 AWS 传输加速 [更新记录](https://x-file-storage.xuyanwu.cn/#/更新记录?id=_240)
<br />
