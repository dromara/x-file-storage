...
public class CopyAspectChain {
     ...
     * 调用下一个切面
     */
    public FileInfo next(FileInfo fileInfo, CopyPretreatment pre, FileStorage fileStorage, FileRecorder fileRecorder) {
        if (aspectIterator.hasNext()) { // 还有下一个
            return aspectIterator.next().copyAround(this, fileInfo, pre, fileStorage, fileRecorder);
        } else {
