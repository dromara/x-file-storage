...
| go-fastdfs          | ✔️ | ✔️ | ✔️ | ✔️ | ✔️   | ❌      | ❌       | ❌       | ❌            | ❌          | ❌            | [查看](存储平台?id=OCI_gofastdfs)        |
...
| 火山引擎 TOS      | ✔️     | ✔️            | [查看](https://www.volcengine.com/docs/6349/147050)                                                  |
...
| 天翼云 ZOS       | ❌      | ✔️            | [查看](https://www.ctyun.cn/document/10026735/10028989)                                              |
...
| RustFS        | ❌      | ✔️            | [查看](https://docs.rustfs.com/developer/sdk/java.html)                                              |
| Garage        | ❌      | ✔️            | [查看](https://garagehq.deuxfleurs.fr/documentation/reference-manual/s3-compatibility/)              |
| SeaweedFS     | ❌      | ✔️            | [查看](https://github.com/seaweedfs/seaweedfs/wiki/Amazon-S3-API)                                    |
| 其它兼容 S3 协议的平台 | ❌      | ✔️            |                                                                                                    |
...
### go-fastdfs :id=OCI_gofastdfs

1、使用前需要先配置 IP 白名单，打开 go-fastdfs 的配置文件，将 `admin_ips` 设置为你的 IP ，例如 `["192.168.1.2"]`，然后重启 go-fastdfs

2、由于多次上传相同的文件，go-fastdfs 会自动合并这些文件，导致后上传的文件无法访问，所以需要关闭文件去重功能，打开 go-fastdfs 的配置文件，将 `enable_distinct_file` 设置为 `false`，然后重启 go-fastdfs
