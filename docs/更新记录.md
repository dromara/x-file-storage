...
- 新增 Solon 插件
- GoogleCloud Storage 新增支持手动分片上传
- 升级 Hutool 版本
- 手动分片上传支持信息 org.dromara.x.file.storage.core.platform.MultipartUploadSupportInfo 改为 org.dromara.x.file.storage.core.upload.MultipartUploadSupportInfo
- 优化缩略图异常处理
- 优化代码结构
- 修复分片场景下哈希值一致问题
- 修复 Minio 分片上传偶发性报错
